    ...
    <section class="w-[90%] border border-black/50 dark:border-white/20 rounded-xl p-8 space-y-4">
        ...
        <div class="flex justify-between">
            ...
            <div class="flex flex-col justify-start h-full space-y-2">
                <a href="{{ route('orders.show', $order->id) }}" class=" flex justify-center dark:border-white/20 px-4 py-2 text-xl rounded-md bg-indigo-600 hover:bg-indigo-500">View Order</a>
